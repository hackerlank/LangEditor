...
public:
        ...
        if (element)
        {
            ...
            if (element->name == "code")
            {
                if (!codeRoot)
                {
					...
					parseAttribute(codeRoot,element);
                    return codeRoot;
                }
                return NULL;
            }
            ...
            else if (element->name == "while" && codeRoot)
            {
				...
				whileNode->nodeName = element->name;
                std::string value = element->get("state");
            ...
            else if ((element->name == "switch") && codeRoot)
            {
				...
				sNode->nodeName = element->get("name");
                return sNode;
            }
    ...
    void parseAttribute(CodeNode *logic,lang::LNode *element)
    {
